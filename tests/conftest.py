...
def rpc_config() -> RPCConfigBase:
    ...
    return RPCConfigBase(
        ...
        retry=3,
        request_time_out=10,
        connection_limits=ConnectionLimits(max_connections=100, max_keepalive_connections=50, keepalive_expiry=300),
    )
...
def rpc_helper_instance(rpc_config, mock_async_client, mock_web3):
    ...
    helper._nodes = [{"web3_client": mock_web3, "rpc_url": TEST_RPC_URL}]
